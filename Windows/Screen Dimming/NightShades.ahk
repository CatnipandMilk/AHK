...
;	╚═╝░░░░░╚═╝╚═╝╚══════╝╚═╝░░╚═╝╚═╝░╚════╝░░╚════╝░╚═╝░░░░░╚═╝
;
;@Ahk2Exe-SetName NightShades.exe
;@Ahk2Exe-SetDescription NightShades - Dims the screen.
;@Ahk2Exe-SetVersion 1.2
;@Ahk2Exe-SetCopyright CatnipandMilk © 2022
;@Ahk2Exe-SetCompanyName Catnip and Milk


program_name:="NightShades"
program_name:="Author: Catnip"
program_name:="Copyright CatnipandMilk, 2022"
...
GUI:
Gui,+ToolWindow -Disabled -SysMenu -Caption -DPIScale +E0x20 +AlwaysOnTop 
Gui,Color,000000
Gui,Show,% "X" vsX " Y" vsY " W" vsW " H" vsH, %applicationname% Screen
Gui,+LastFound
WinGet,guiid,Id,A
Gosub,CHANGE
Return
...
Gui,2:Font,Bold
Gui,2:Add,Text,x+10 yp+10,%applicationname% v2.1
Gui,2:Font
...
Gui,2:Add,Text,xp y+5,- Doesn't work properly with some windows.
Gui,2:Add,Text,xp y+5,- Screen caps will also be dimmed!

Gui,2:Add,Picture,xm y+20 Icon2,%applicationname%.exe
Gui,2:Font,Bold
Gui,2:Add,Text,x+10 yp+10,Catnip and Milk
Gui,2:Font
Gui,2:Add,Text,y+10,For more tools, information and donations, please visit 
Gui,2:Font,CBlue Underline
Gui,2:Add,Text,y+5 GCatnipandMilk,www.Catnipandmilk.com
Gui,2:Font
...
Gui,2:Font
Gui,2:Add,Text,y+10,This tool was made using 
Gui,2:Font,CBlue Underline
...
CatnipandMilk:
Run,http://www.catnipandmilk.com,,UseErrorLevel
Return
